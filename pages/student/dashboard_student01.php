        ...
        <div class="container-fluid">
          <div class="row">
            <section class="col-lg-6 connectedSortable">
              <div class="card" style="background-color: #d499f2;">
                <div class="card-body">
                  <h4 class="card-title">Maklumat Umum</h4><br>
              ...
              <div class="card">
                <div class="card-body" style="background-color: #d4fcb3;">
                  <h3 class="card-title">Graf Prestasi Mingguan</h3><br>
